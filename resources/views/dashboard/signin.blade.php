...
<head>
    <title>CitieClik -Signin | Dashboard</title>
...
<body class="fix-menu">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material">
                            <div class="text-center">
                                <img src="/assets/img/logo/logo_bw.png" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <img src="/assets2/images/auth/Logo-small-bottom.png" alt="small-logo.png">
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <script src="/assets2/bower_components/modernizr/js/css-scrollbars.js"></script>

    <script src="/assets2/bower_components/i18next/js/i18next.min.js"></script>
    <script src="/assets2/bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js"></script>
    <script src="/assets2/bower_components/i18next-browser-languagedetector/js/i18nextBrowserLanguageDetector.min.js"></script>
