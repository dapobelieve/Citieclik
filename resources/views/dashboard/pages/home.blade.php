          ...
          <div class="col-md-6 col-xl-3">
             <div class="card bg-c-blue order-card">
                <div class="card-block">
                   ...
                   {{-- <p class="m-b-0">Completed Orders<span class="f-right">3</span></p> --}}
                </div>
             </div>
          </div>
          <div class="col-md-6 col-xl-3">
             <div class="card bg-c-green order-card">
                <div class="card-block">
                   <h6 class="m-b-20">Total Services</h6>
                   <h2 class="text-right"><i class="ti-tag f-left"></i><span>250</span></h2>
          ...
          <div class="col-md-6 col-xl-3">
             <div class="card bg-c-yellow order-card">
                <div class="card-block">
                   ...
                   <h2 class="text-right"><i class="ti-reload f-left"></i><span>42</span></h2>
          ...
          <div class="col-md-6 col-xl-3">
             <div class="card bg-c-pink order-card">
                <div class="card-block">
                   ...
                   <h2 class="text-right"><i class="ti-wallet f-left"></i><span>23</span></h2>
