@foreach($sdata as $data)
	<div class="card mb-4">
      	...
      	<div class="card-block">
        	<div class="d-flex"><a class="pr-4 hidden-xs-down" href="shop-single.html" style="max-width: 225px;"><img src={{$data->servieImage()}} alt="Product" height="50" style="height: 150px !important;"></a>
          		<div>
