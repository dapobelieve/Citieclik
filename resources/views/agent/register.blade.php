...
<head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="/agent/css/bootstrap.css" rel="stylesheet">

        <!-- Font Awesome CSS -->
        <link href="agent/fonts/font-awesome/css/font-awesome.css" rel="stylesheet">

        <link href="/agent/css/animations.css" rel="stylesheet">
    ...
    <body class="no-trans  ">
            ...
            <div class="pv-40 dark-translucent-bg">
                <div class="container">
                    <div class="object-non-visible text-center" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
                        ...
                        <!-- name-and-slogan -->
                        <p class="small">Sales Agent Registration</p>
        ...
        <script type="text/javascript" src="/agent/js/jquery.min.js"></script>
        <script type="text/javascript" src="/agent/js/bootstrap.min.js"></script>

        <!-- Modernizr javascript -->
        <script type="text/javascript" src="/agent/js/modernizr.js"></script> 
        ...
        <script type="text/javascript" src="/agent/js/jquery.browser.js"></script>
        <script type="text/javascript" src="/agent/js/SmoothScroll.js"></script>


        <!-- Initialization of Plugins -->
        <script type="text/javascript" src="/agent/js/template.js"></script>
        <!-- Color Switcher End -->
    </body>
</html>
